...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_session_adapter_redis_setoptions, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(phalcon_session_adapter_redis_method_entry) {
	...
	PHP_ME(Phalcon_Session_Adapter_Redis, setOptions, arginfo_phalcon_session_adapter_redis_setoptions, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
